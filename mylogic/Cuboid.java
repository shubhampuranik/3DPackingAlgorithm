...
public class Cuboid {
    ...
    public String toString(){
        return "("+id+" "+isFragile+" L="+length+",B="+breadth+",H="+height+",BLR="+bottomLeftRear+",BRR="+bottomRightRear+",BRF="+bottomRightFront+",BLF="+bottomLeftFront+",TLF="+topLeftFront+",TLR="+topLeftRear+",TRR="+topRightRear+",TRF="+topRightFront+" COLOR=("+color[0]+","+color[1]+","+color[2]+"))";
    }
    public void rotate(){
